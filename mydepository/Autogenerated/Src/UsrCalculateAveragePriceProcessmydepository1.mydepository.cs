namespace Terrasoft.Core.Process
{
	...
	#region Class: UsrCalculateAveragePriceProcessmydepository1MethodsWrapper

	/// <exclude/>
	public class UsrCalculateAveragePriceProcessmydepository1MethodsWrapper : ProcessModel
	{

		public UsrCalculateAveragePriceProcessmydepository1MethodsWrapper(Process process)
			: base(process) {
		...
		private bool ScriptTask1Execute(ProcessExecutingContext context) {
			...
			// select UsrPriceUSD as UsrPriceUSD,UsrAreaM2 as UsrAreaM2 from UsrRealty where ...
